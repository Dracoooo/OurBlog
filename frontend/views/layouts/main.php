...
<div class="wrap">
    ...
    NavBar::begin([
        ...
        'brandLabel'=>Yii::t('common','Small Club'),
    ...
    $leftItems = [
        ['label' => '<i class=""></i>'.Yii::t('common','Home'), 'url' => ['/site/index']],
    ...
    if (Yii::$app->user->isGuest) {
       ...
       /* $menuItems[] = '<li>'
        ...
        $rightItems[]=[
            ...
            'items'=>[
                    [ 'label'=>'<i class="fa fa-star-o"></i>   &nbsp;'.Yii::t('common','Myzone'), 'url'=>['/site/myzone'], 'linkOptions'=>['data-method'=>'post'] ],
                    [ 'label'=>'<i class="fa fa-cog"></i>   &nbsp; '.Yii::t('common','Setting'), 'url'=>['/site/setting'], 'linkOptions'=>['data-method'=>'post'] ],
